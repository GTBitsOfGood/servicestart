  ...
  return (
    <>
      <BogModal
        ...
        title={
          <span className="text-heading-4 text-grey-text-strong">
            Send Email
          </span>
        }
        description={
                  ...
                  content={
                    <span className="flex items-center gap-3">
                      ...
                      <BogButton
                        ...
                        disabled={isSending || !onRetryRecipients}
                      >
                        Retry
                      </BogButton>
                    </span>
