...
export default function EventsCreationPage() {
  ...
  const handleSubmit = async () => {
    ...
    const body = {
      ...
      ...(eventCapacity != "" && { rsvpLimit: parseInt(eventCapacity) }),
  ...
  }, [session?.data?.user, organization?.data, router]);

  return (
    <div className="flex w-full px-14 py-12 flex-col items-center gap-12 rounded-[10px] bg-white">
      <div className="h-[68.717px] w-[90%] flex flex-col justify-between">
        <div className="flex w-full justify-between items-center">
          <h4 className="text-black text-[24px] leading-normal font-semibold">
            Event Creation Form
          </h4>
        ...
        <div className="w-full">
          ...
          >
            <path d="M0 0.5L1053 0.500111" stroke="#9C9C9C" />
          </svg>
        </div>
      </div>
      <div className="flex flex-col items-end gap-15 w-[90%]">
        <div className="flex flex-col items-start gap-9 self-stretch w-full">
          ...
          <div>
            <BogTextInput
              ...
              error={missing && title === ""}
              className="w-[670px] self-start gap-2"
            />
            {missing && title === "" && (
          ...
          <div className="flex items-start gap-6 self-stretch">
            ...
            {/* <div className="flex flex-col gap-3 w-[21%]">
              ...
              <BogDropdown
                ...
                value={timezone}
                onSelectionChange={(val) => setTimezone(val as string)}
                placeholder="EST"
              />
            </div> */}
          </div>
        ...
        <div className="flex flex-col iterms-start gap-9 self-stretch">
          <h6 className="text-black text-[20px] leading-[26px] font-medium">
            ...
            <div className="h-[68.717px] self-stretch">
              <div className="w-full">
                ...
                <svg
                  ...
                  fill="none"
                >
                  <path d="M0 0.5L532 0.500056" stroke="#9C9C9C" />
                </svg>
              </div>
            </div>
